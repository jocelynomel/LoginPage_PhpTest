                        ...
                        <div class="col-lg-4 col-lg-offset-4 text-center">
                                <div class="search-box">
                                        <div class="text-center">
                                                <h3>Please enter your sign-in informations</h3>
                                        </div>
                                        <form action="/projet_test_php_java/idValidation.php" method="post" id="loginForm" class="loginForm">
                                                <div class="input-group">
                                                        ...
                                                        <input type="password" name="pswdConfirm" id="pswdConfirm" class="form-control" placeholder="Confirm password" required>
                                                        <input type="submit" name="signInSubmit" id="submit" class="form-control" value="Sign in">
                                                        <a href="/projet_test_php_java/SignUp.php">Not registered? Click here to sign up</a>
                                                </div>
                                        </form>
                                </div>
                        </div>
